(function(){
  ...
  function sync(force){
    ...
    if(force||loadedKey!==key){loadedKey=key;player.loadVideoById({videoId:state.activeVideoId,startSeconds:state.mediaSeconds});player.setVolume(100);verifyPlayback(state.activeVideoId,state.isIntro||block.type==="cartoon");return;}
